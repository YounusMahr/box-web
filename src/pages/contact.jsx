        ...
        <div className="row">
          ...
          <div className="col-md-5">
            ...
            <div className="mt-3 mb-4 set_form_icon_data">
              <div className="mb-3">
                <img
                  src="../frontend_f/front/time_clock.svg"
                  alt="time clock"
                  className="width_50"
                />
              </div>
      ...
      <div className="container">
        ...
        <div id="brands" className="owl-carousel owl-theme">
          <div className="item">
            <a href="#0">
              <img
                src="../frontend_f/front/brand_4.svg"
                width={120}
                height={30}
          ...
          <div className="item">
            <a href="#0">
              <img
                src="../frontend_f/front/brand_6.svg"
                width={120}
                height={30}
          ...
          <div className="item">
            <a href="#0">
              <img
                src="../frontend_f/front/brand_2.svg"
                width={120}
                height={30}
          ...
          <div className="item">
            <a href="#0">
              <img
                src="../frontend_f/front/brand_3.svg"
                width={120}
                height={30}
          ...
          <div className="item">
            <a href="#0">
              <img
                src="../frontend_f/front/brand_7.svg"
                width={120}
                height={30}
                data-src="https://www.thecustomboxes.com/frontend_f/front/brand_7.svg"
                alt="Brand 7"
                className="owl-lazy"
              />
            </a>
          ...
          <div className="item">
            <a href="#0">
              <img
                src="../frontend_f/front/brand_5.svg"
                width={120}
                height={30}
                data-src="https://www.thecustomboxes.com/frontend_f/front/brand_5.svg"
                alt="Brand 5"
                className="owl-lazy"
              />
            </a>
          ...
          <div className="item">
            <a href="#0">
              <img
                src="../frontend_f/front/brand_9.svg"
                width={120}
                height={30}
          ...
          <div className="item">
            <a href="#0">
              <img
                src="../frontend_f/front/brand_1.svg"
                width={120}
                height={30}
